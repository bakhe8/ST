...
Capture normative system requirements, APIs, data models, and acceptance criteria used to implement and verify the product roadmap.
...
- Owner: System Specification Owner
