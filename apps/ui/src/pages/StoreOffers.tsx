  ...
  return (
    ...
    >
      ...
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "2fr 1fr 2fr 1fr 1fr 2fr 1fr 1fr 1fr auto",
          gap: 8,
          marginBottom: 18,
        }}
      >
        ...
        <select
          ...
          onChange={(e) =>
            setNewItem((prev) => ({ ...prev, discount_type: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <input
          ...
          onChange={(e) =>
            setNewItem((prev) => ({ ...prev, starts_at: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <input
          ...
          onChange={(e) =>
            setNewItem((prev) => ({ ...prev, ends_at: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        >
          <input
            ...
            onChange={(e) =>
              setNewItem((prev) => ({ ...prev, is_active: e.target.checked }))
            }
          />
          نشط
        </label>
