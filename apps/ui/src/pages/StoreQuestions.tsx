...
const StoreQuestions: React.FC = () => {
  ...
  const handleAdd = () => {
    ...
    const payload = {
      ...newItem,
      is_answered:
        Boolean(newItem.answer?.trim()) || Boolean(newItem.is_answered),
    };
  ...
  const handleSaveEdit = (id: string) => {
    const payload = {
      ...editItem,
      is_answered:
        Boolean(editItem.answer?.trim()) || Boolean(editItem.is_answered),
    };
  ...
  const productLabel = (productId: string) =>
    products.find((entry) => String(entry.id) === String(productId))?.name ||
    productId ||
    "-";
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "2fr 2fr 2fr 2fr 1fr 1fr auto",
          gap: 8,
          marginBottom: 18,
        }}
      >
        <select
          ...
          onChange={(e) =>
            setNewItem((prev) => ({ ...prev, product_id: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <input
          ...
          onChange={(e) =>
            setNewItem((prev) => ({ ...prev, customer_name: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        >
          <input
            ...
            onChange={(e) =>
              setNewItem((prev) => ({ ...prev, is_answered: e.target.checked }))
            }
          />
          مجاب
        </label>
