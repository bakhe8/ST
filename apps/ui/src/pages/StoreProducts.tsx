...
const StoreProducts = () => {
  ...
  const isExternalPlaceholder = (url?: string) =>
    !!url && /via\.placeholder\.com/i.test(url);
  ...
  const getDisplayQuantity = (product: Product) => {
    if (typeof product.available_quantity === "number")
      return String(product.available_quantity);
  ...
  const getStatusView = (product: Product) => {
    ...
    if (rawStatus === "hidden")
      return { label: "Hidden", bg: "rgba(148,163,184,0.2)", color: "#94a3b8" };
    ...
    if (isOut)
      return {
        label: rawStatus === "out-and-notify" ? "Out + Notify" : "Out of Stock",
      ...
      >
        ...
        >
          <thead>
            ...
            >
              <th style={{ padding: 16, borderBottom: "1px solid #334155" }}>
                Product
              </th>
              <th style={{ padding: 16, borderBottom: "1px solid #334155" }}>
                Images
              ...
              <th
                style={{ padding: 16, borderBottom: "1px solid #334155" }}
              ></th>
            </tr>
          </thead>
          <tbody>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {product.main_image ? (
                          <img
                            src={resolveImageSrc(product.main_image)}
                            alt=""
                            style={{
                              width: "100%",
                              height: "100%",
                          ...
                          <img
                            src={resolveImageSrc(product.image.url)}
                            alt=""
                            style={{
                              width: "100%",
                              height: "100%",
                    ...
                    <td style={{ padding: 16 }}>
                      ...
                      <span style={{ fontSize: 12, color: "#94a3b8" }}>
                        {getPriceCurrency(product.price)}
                      </span>
                    </td>
                    <td style={{ padding: 16 }}>
                      <div
                        ...
                        >
                          <button
                            ...
                            onClick={() => {
                              handleMenuClose();
                              navigate(
                                `/store/${storeId}/products/${product.id}/edit`,
                              );
                            }}
                          >
                            تعديل المنتج
