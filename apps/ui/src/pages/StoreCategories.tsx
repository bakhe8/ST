      ...
      <tr key={cat.id} style={{ borderBottom: "1px solid #334155" }}>
        <td style={{ padding: 12 }}>
          {editId === cat.id ? (
            ...
            <span style={{ paddingRight: level * 16 }}>
              {"— ".repeat(level)}
              {cat.name}
            </span>
          )}
        ...
        <td style={{ padding: 12 }}>
          {editId === cat.id ? (
            <input
              value={editCat.url}
              onChange={(e) => setEditCat({ ...editCat, url: e.target.value })}
              style={{
                width: "100%",
                padding: 6,
                borderRadius: 4,
        ...
        <td style={{ padding: 12 }}>
          {editId === cat.id ? (
            <select
              ...
              onChange={(e) =>
                setEditCat({ ...editCat, parentId: e.target.value })
              }
              style={{
                width: "100%",
                padding: 6,
        ...
        <td style={{ padding: 12 }}>
          {editId === cat.id ? (
            <input
              ...
              onChange={(e) =>
                setEditCat({ ...editCat, order: Number(e.target.value) })
              }
              style={{
                width: "100%",
                padding: 6,
    ...
    >
      ...
      >
        ...
        <input
          placeholder="الرابط"
          value={newCat.url || ""}
          onChange={(e) => setNewCat({ ...newCat, url: e.target.value })}
          style={{
            flex: 1,
            padding: 8,
            borderRadius: 6,
