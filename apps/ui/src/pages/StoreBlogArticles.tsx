...
const StoreBlogArticles: React.FC = () => {
  ...
  const [newArticle, setNewArticle] =
    useState<Partial<BlogArticle>>(emptyArticle);
  ...
  const fetchAll = () => {
    ...
    Promise.all([
      ...
      fetch(apiUrl("v1/blog/categories"), { headers }).then((res) =>
        res.json(),
      ),
    ])
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "2fr 1fr 2fr 2fr 2fr 1fr auto",
          gap: 8,
          marginBottom: 18,
        }}
      >
        ...
        <input
          ...
          onChange={(e) =>
            setNewArticle((prev) => ({ ...prev, slug: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <input
          ...
          onChange={(e) =>
            setNewArticle((prev) => ({ ...prev, summary: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <input
          ...
          onChange={(e) =>
            setNewArticle((prev) => ({ ...prev, url: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
        ...
        <select
          ...
          onChange={(e) =>
            setNewArticle((prev) => ({ ...prev, category_id: e.target.value }))
          }
          style={{
            padding: 8,
            borderRadius: 6,
