...
const SystemLayout = () => {
    return (
        <div style={{ minHeight: '100vh', background: '#0f172a', color: 'white', display: 'flex', flexDirection: 'column' }}>
            {/* System Header */}
            <header style={{ padding: '0 24px', height: 64, borderBottom: '1px solid #1e293b', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#1e293b' }}>
                ...
                <div style={{ display: 'flex', gap: 16 }}>
                    <Link to="/" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: 14 }}>Stores</Link>
                    <Link to="/settings" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: 14 }}>System Settings</Link>
                </div>
            </header>
