...
const StoreLayout = () => {
  ...
  const menu = [
    ...
    },
    {
      ...
      icon: HelpCircle,
      path: `/store/${storeId}/questions`,
    },
    {
      id: "static-pages",
      label: "الصفحات الثابتة",
      icon: Book,
      path: `/store/${storeId}/static-pages`,
    },
    {
      id: "menus",
      label: "قوائم التنقل",
      icon: ListTree,
      path: `/store/${storeId}/menus`,
    },
    {
      id: "blog-categories",
      label: "تصنيفات المدونة",
      icon: Tags,
      path: `/store/${storeId}/blog/categories`,
    },
    {
      id: "blog-articles",
      label: "مقالات المدونة",
      icon: Newspaper,
      path: `/store/${storeId}/blog/articles`,
    },
    {
      id: "theme",
      label: "تخصيص الثيم",
      icon: Palette,
      path: `/store/${storeId}/theme`,
    },
    {
      id: "theme-components",
      label: "مكونات الصفحات",
      icon: Book,
      path: `/store/${storeId}/theme-components`,
    },
    {
      id: "settings",
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, color: "#94a3b8" }}>
            Visual Store Simulator
          </div>
          <Link
            to={`/store/${storeId}/preview`}
