...
const SEED_PROFILES: Record<SeedProfileId, SeedProfileDefinition> = {
  general: {
    ...
    storeDescription:
      "متجر تجريبي عام ببيانات متوازنة لمحاكاة أغلب حالات العرض.",
    ...
    blogArticleTitles: [
      ...
      "دليل سريع للاستفادة من العروض",
      "نصائح للعناية بمنتجاتك",
      "أفضل اختيارات هذا الشهر",
    ],
    offerTitles: [
      "عرض البدايات",
      "خصم نهاية الأسبوع",
  ...
  fashion: {
    ...
    blogArticleTitles: [
      "ألوان الموسم الحالية",
      "كيفية تنسيق الإطلالات اليومية",
      "دليل المقاسات السريع",
      "اختيار القطع الأساسية لخزانتك",
    ],
    offerTitles: [
      "خصم الأزياء",
      "عرض الإطلالة الكاملة",
      "تخفيضات الأحذية",
      "صفقة الإكسسوارات",
    ],
  ...
  electronics: {
    ...
    blogArticleTitles: [
      "كيف تختار هاتفك القادم؟",
      "مقارنة بين الفئات السعرية",
      "أفضل ملحقات الإنتاجية",
      "نصائح لحماية أجهزتك",
    ],
    offerTitles: [
      "عرض الإلكترونيات",
...
export function getSeedProfileDefinition(
  value: unknown,
): SeedProfileDefinition {
