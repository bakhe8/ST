(() => {
    ...
    function c() {
      return (
        ...
        (function (e, n) {
          ...
          e,
          l() ? Reflect.construct(n, o || [], r(e).constructor) : n.apply(e, o),
        )
      );
      var e, n, o;
    }
      ...
      (a = [
        ...
        },
        {
          ...
          value: function () {
            (this.setAttribute(
              "id",
              "wishlist-product-".concat(this.product.id),
            ),
              ...
              (this.innerHTML =
                '\n        <div class="flex items-center mb-4 sm:mb-0">\n          <a href="'
                  ...
                  .concat(this.product.image.url, '" loading="lazy" alt="')
                  .concat(
                  ...
                  .concat(
                    this.product.is_on_sale
                      ? '\n                <div class="space-x-1 rtl:space-x-reverse">\n                  <h4 class="inline-block text-sm font-bold text-red-400">'
                          .concat(
                            salla.money(this.product.sale_price),
                            '</h4>\n                  <span class="text-sm text-gray-500 line-through">',
                          )
                          .concat(
                            salla.money(this.product.regular_price),
                            "</span>\n                </div>\n              ",
                          )
                      : '\n                <h4 class="text-sm font-bold">'.concat(
                          salla.money(this.product.price),
                          "</h4>\n              ",
                        ),
                    '\n            </div>\n          </div>\n        </div>\n        <div class="flex items-center space-x-4 rtl:space-x-reverse">\n          <salla-add-product-button product-status="',
                  )
                  .concat(this.product.status, '" product-id="')
                  .concat(this.product.id, '" product-type="')
                  .concat(
                    this.product.type,
                    '" loader-position="center" fill="outline" class="flex-grow w-full sm:grow-0 md:w-40">\n          </salla-add-product-button>\n          <salla-button loader-position="center" shape="icon" size="small" color="danger" class="btn--delete" onclick="salla.wishlist.remove(',
                  )
                  .concat(
                    this.product.id,
  ...
  customElements.define("custom-wishlist-card", a);
})();
