(() => {
    ...
    function o() {
      return (
        ...
        (function (e, n) {
          ...
          e,
          c() ? Reflect.construct(n, i || [], r(e).constructor) : n.apply(e, i),
        )
      );
      var e, n, i;
    }
    return (
      ...
      (a = [
        ...
        },
        {
          key: "render",
          value: function () {
            if (this.settings && 0 !== Object.keys(this.settings).length) {
              var t = function (t) {
                  return salla.lang.get(t);
                },
                e = Array.isArray(this.settings.formats)
              ...
              this.innerHTML =
                '\n            <section class="bg-white p-5 rounded-md mb-5 last:mb-0">\n                <ul class="space-y-4">\n                    <li class="flex items-center justify-between">\n                        <div class="flex items-center gap-3">\n                            <i class="sicon-page"></i>\n                            <div class="text-gray-600 text-sm">'
                  .concat(
                    t("pages.products.number_of_files"),
                  ...
                  .concat(
                    t("pages.products.file_expiration_period"),
                    '</div>\n                        </div>\n                        <div class="text-gray-900 text-sm">',
                  )
                  .concat(
        ...
        },
        {
          key: "accessFileList",
          value: function () {
            return this.settings.access_new_files
              ? '\n        <li class="flex items-center justify-between">\n            <div class="flex items-center gap-3">\n                <i class="sicon-rotate"></i>\n                <div class="text-gray-600 text-sm">'.concat(
                  salla.lang.get("pages.products.free_access_to_new_files"),
  ...
  customElements.define("digital-files-settings", a);
})();
