...
(() => {
  var t = {
      ...
      87: (t, e, r) => {
        ...
        function l() {
          ...
          var e = o(),
            r = e.m(l),
            p = (Object.getPrototypeOf ? Object.getPrototypeOf(r) : r.__proto__)
              .constructor;
          function d(t) {
        ...
        function o() {
                          ...
                          if ((a || (o = "next"), (r = i[o]))) {
                            ...
                            (1 === a && (r = i.return) && r.call(i),
                              a < 2 &&
                                ...
                                (a = 1)));
                          i = e;
                        } else if ((r = (p = d.n < 0) ? s : t.call(n, d)) !== c)
                          break;
                      } catch (t) {
                        ((i = e), (a = 1), (s = t));
                      } finally {
          ...
          var f = [][a]
              ...
              : (n((r = {}), a, function () {
                ...
                r),
            v = (d.prototype = l.prototype = Object.create(f));
          function h(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, d)
                : ((t.__proto__ = d), n(t, s, "GeneratorFunction")),
  ...
  ((r.n = (t) => {
    ...
    (() => {
        ...
        function n() {
          ...
          return (
            ...
            (t = (function (t, r) {
              ...
              r,
              p() ? Reflect.construct(o, [], i(r).constructor) : o.apply(r, a),
            )).classList.add("s-add-product-toast"),
            (t.isVisible = !1),
            (t.progressInterval = null),
            (t.remainingTime = 0),
            (t.isPaused = !1),
            (t.duration = 5e3),
            t
              ...
              value: function () {
                ...
                (salla.lang.onLoaded(function () {
                  (salla.lang.addBulk({
                    ...
                    (t.successMessage = salla.lang.get(
                      "pages.cart.added_to_cart",
                    )),
                    (t.viewCartText = salla.lang.get("pages.cart.view_cart")),
                    (t.checkoutText = salla.lang.get(
                      "pages.cart.complete_order",
                    )),
                    (t.showMoreText = salla.lang.get(
                      "pages.checkout.show_more",
                    )));
                }),
                  (this.cartUrl = salla.url.get("cart")),
                  (this.checkIconUrl = salla.url.asset("images/check.svg")),
                  salla.event.on("Product Added", function (e) {
                    return t.handleProductAdded(e);
                  }),
                  this.render());
              },
            },
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            if (((t.prev = 0), (n = e || []).length)) {
                              t.next = 1;
                              break;
                            }
                            return t.abrupt("return");
                          case 1:
                            if ((o = n[0].cart_item_id)) {
                              t.next = 2;
                              break;
                            }
                            return t.abrupt("return");
                          ...
                          case 4:
                            if (
                              (a = i.data.cart.items.find(function (t) {
                                return t.id === o;
                              }))
                            ) {
                              t.next = 5;
                          ...
                          case 5:
                            (this.open({
                              ...
                              price: a.total,
                              originalPrice: a.original_price * a.quantity,
                              hasDiscount: a.has_discount,
                              isOnSale: a.is_on_sale,
                              quantity: a.quantity,
                              url: a.url,
                              options: this.extractOptions(a.options),
                            }),
                              (t.next = 7));
                            break;
                          case 6:
                ...
                return null != t && t.length
                  ? t.reduce(function (t, e) {
                      ...
                      if (
                        ...
                        var n =
                          "multiple-options" === e.type
                            ? e.details.filter(function (t) {
                                return t.is_selected;
                              })
                            : [
                                e.details.find(function (t) {
                                  return t.is_selected;
                                }),
                              ];
                        n[0] &&
                        ...
                        var o = ["image", "file", "map"].includes(e.type);
                        t.push({ name: e.name, value: e.value, hideValue: o });
                      }
                      return t;
                    }, [])
                  : [];
              ...
              value: function (t) {
                ...
                ((this.product = t),
                  ...
                  requestAnimationFrame(function () {
                    e.classList.add("s-add-product-toast--visible");
                  }),
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.clearTimers(),
                  ...
                  setTimeout(function () {
                    ((t.isVisible = !1), (t.product = null), t.updateDOM());
                  }, 300));
              },
            },
            {
              ...
              value: function () {
                ...
                (this.clearTimers(),
                  ...
                  (this.progressInterval = setInterval(function () {
                    if (!t.isPaused) {
                      ((t.remainingTime = Math.max(0, t.remainingTime - 50)),
                        (t.progressPercent =
                          (t.remainingTime / t.duration) * 100));
                      var e = t.querySelector(
                        ".s-add-product-toast__progress-bar",
                      );
                      (e && (e.style.width = "".concat(t.progressPercent, "%")),
                        t.remainingTime <= 0 && t.close());
                    }
                  }, 50)));
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.isVisible && this.product) {
                  var e = this.product.options || [],
                    r = e.slice(0, 3),
                    n = e.length > 3,
                    o = salla.money(this.product.price),
                    i = salla.money(this.product.originalPrice);
                  (this.setAttribute("onmouseenter", "this.isPaused=true"),
                    this.setAttribute("onmouseleave", "this.isPaused=false"),
                    (this.innerHTML =
                      '\n      <div class="s-add-product-toast__progress">\n        <div class="s-add-product-toast__progress-bar" style="width:'
                        .concat(
                        ...
                        .concat(
                          this.checkIconUrl,
                          '" alt="Success" width="16" height="16" class="s-add-product-toast__icon" />\n          <span class="s-add-product-toast__title">',
                        )
                        .concat(
                          this.successMessage,
                        ...
                        .concat(
                          this.product.url,
                          '" class="s-add-product-toast__image">\n          <img src="',
                        )
                        .concat(this.product.image, '" alt="')
                        .concat(
                        ...
                        .concat(
                          this.product.url,
                          '" class="s-add-product-toast__name">',
                        )
                        .concat(
                          this.escapeHTML(this.product.name),
                          "</a>\n          ",
                                ...
                                .concat(
                                  n
                                    ? '<a href="'
                                        .concat(
                                          this.cartUrl,
                                          '" class="s-add-product-toast__show-more">',
                                        )
                                        .concat(this.showMoreText, "</a>")
                                    : "",
                                  "\n            </div>\n          ",
                                )
                            : "",
                        ...
                        .concat(
                          this.product.hasDiscount || this.product.isOnSale
                            ? '<div class="s-add-product-toast__price-sale">'
                                .concat(
                                  o,
                                  '</div><div class="s-add-product-toast__price-original">',
                                )
                                .concat(i, "</div>")
                            : "<div>".concat(o, "</div>"),
                        ...
                        .concat(
                          this.cartUrl,
                          '" fill="outline" width="wide" color="gray">\n          <span>',
                        )
                        .concat(
                          this.viewCartText,
                    ...
                    this.querySelector("#toast-submit").addEventListener(
                      "click",
                      function () {
                        (salla.cart.submit(), t.close());
                      },
                    ));
                } else this.innerHTML = "";
              },
      ...
      customElements.define("salla-add-product-toast", d);
    })());
})();
