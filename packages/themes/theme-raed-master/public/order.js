(() => {
  ...
  ((c.initiateWhenReady = function () {
        ...
        o(r, [
          {
            key: "onReady",
            value: function () {
              (app.onClick("salla-button#btn-reorder", function (t) {
                ...
                app.onClick("salla-button#confirm-cancel", function (t) {
                  var e = t.currentTarget;
                  return e
                    .load()
                    .then(function () {
                    ...
                    .then(function () {
                      return (
                        e.stop() && app.element("#modal-order-cancel").hide()
                      );
                    })
                    .then(function () {
    ...
    })(c).initiateWhenReady(["customer.orders.single"]));
})();
