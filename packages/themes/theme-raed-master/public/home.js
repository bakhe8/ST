            ...
            function (e, t, n) {
                ...
                ((this.handleImageLoad = function (e) {
                  ...
                  (this.handleCustomLoad = function () {
                    var e = i[t],
                      n = e.offsetWidth,
                      r = e.offsetHeight;
                    n && r ? s.b(n, r) : setTimeout(o.handleCustomLoad);
                  }));
              }
              function A(e, t, n) {
              ...
              function j(e, t, n) {
                var o = document.createElementNS(
                  ...
                  r = "".concat(i, "svg");
                (o.setAttributeNS(null, "class", "".concat(r)),
                ...
                return (
                  s.setAttributeNS(null, "class", "".concat(r, "p")),
                    ...
                    ((n.className = "".concat(i, "toolbar")),
                      ...
                      (function (e, t) {
                        if (!e.hfs) {
                          ...
                          var r = j(o, "0 0 18 18", n);
                          ((e.fso = function () {
                            ((e.ifs = 1),
                              (o.title = "Exit fullscreen"),
                              r.classList.add("".concat(i, "fsx")),
                            ...
                            (e.fsx = function () {
                              ((e.ifs = 0),
                                (o.title = "Enter fullscreen"),
                                r.classList.remove("".concat(i, "fsx")),
                                r.setAttributeNS(null, "viewBox", "0 0 18 18"),
                                r.firstChild.setAttributeNS(null, "d", n));
                            }),
                            (o.onclick = e.fs.t));
                        }
                      })(e, n),
              ...
              function Y(e) {
                ...
                this.runActions = function () {
                  ((t.i = 1),
                    s.container.classList.add(b),
                    i.removeListeners(),
                    c.exitFullscreenOnClose && e.ifs && a.x(),
                    setTimeout(function () {
                      ((t.i = 0),
                        (u.isPointering = !1),
                        s.container.classList.remove(b),
                      ...
                      function x() {
                        ...
                        ((v = !0),
                          ...
                          (function (e) {
                            ...
                            for (var r = 0; r < o.length; r++) O(e, r);
                          })(e),
                          e.props.sources.length > 1 &&
          ...
          function o() {
            return (
              ...
              (function (e, n) {
                ...
                n,
                p()
                  ? Reflect.construct(i, r || [], s(n).constructor)
                  : i.apply(n, r),
              )
            );
            var n, i, r;
          ...
          return (
            ...
            r(o, [
              ...
              },
              {
                ...
                value: function () {
                  (app.all(".tab-trigger", function (e) {
                    e.addEventListener("click", function (e) {
                      var t = e.currentTarget,
                        n = t.dataset.componentId;
                      (app
                        .toggleClassIf(
                          "#".concat(n, " .tabs-wrapper>div"),
                          "is-active opacity-0 translate-y-3",
                          "inactive",
                          function (e) {
                            return e.id == t.dataset.target;
                          },
                        )
                        .toggleClassIf(
                          "#".concat(n, " .tab-trigger"),
                          "is-active",
                          "inactive",
                          function (e) {
                            return e == t;
                    ...
                    document
                      ...
                      .forEach(function (e) {
                        return e.classList.add("tabs-initialized");
                      }));
                },
              },
            ])
          );
        })(l).initiateWhenReady(["index"]));
    })());
})();
